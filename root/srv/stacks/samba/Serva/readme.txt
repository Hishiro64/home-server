...
"Serva" is a read-only smb network share.
---
Credentials:
user=admin
password=changeme
...
[In Fedora] (SMB/Nautilus)
1. Same as SMB/Nautilus but in server address, enter: dav://192.168.1.200:5001/
2. No credentials
